...
>(({ children }, ref) => {
  return (
    <motion.button
      ref={ref}
      className="group relative flex items-center gap-2 rounded-lg bg-yellow-400 px-4 py-2 text-sm font-medium text-gray-800 transition-colors hover:bg-yellow-400 hover:text-black"
      whileHover="hover"
      initial="default"
    >
      <motion.div
