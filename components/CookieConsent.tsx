                ...
                <div className="dark:bg-card bg-background rounded-md m-3 border border-border shadow-lg">
                    <div className="grid gap-2">
                        ...
                        <div className="flex gap-2 p-4 py-5 border-t border-border dark:bg-background/20">
                            <Button onClick={accept} className="w-full">Accepter</Button>
                            <Button onClick={decline} className="w-full" variant="secondary">Refuser</Button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="m-3 dark:bg-card bg-background border border-border rounded-lg">
                    ...
                    <div className="p-3 -mt-2">
                        <p className="text-sm text-left text-muted-foreground">
                            Nous utilisons des cookies pour garantir que vous bénéficiez de la meilleure expérience sur notre platforme. Pour plus d'informations sur l'utilisation des cookies, veuillez consulter notre politique en matière de cookies.
                        </p>
                    </div>
                    <div className="p-3 flex items-center gap-2 mt-2 border-t">
                        <Button onClick={accept} className="w-full h-9 rounded-full">Accepter</Button>
                        <Button onClick={decline} className="w-full h-9 rounded-full" variant="outline">Refuser</Button>
                    </div>
                </div>
            </div>
        )
